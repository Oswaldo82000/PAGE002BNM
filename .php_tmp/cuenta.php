...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white">
    ...
    </svg><span class="ms-2"> CARL ERNEST KASTEN</span></a>
</header>
    ...
    alert('La contraseña es incorrecta.'); // Mostrar un mensaje de alerta si el valor no coincide
            ...
            <li class="mb-1">
              ...
              <div class="  border-start" id="orders-collapse">
                <ul class="btn-toggle-nav border-start text-end me-3 list-unstyled fw-normal pb-1 small">
                  <li>
                    <span class="mb-3 small fw-semibold text-success">+$2,590,254.00 MXN   27/06/2024</span>
                  </li> 
                </ul>
              </div>
            </li>
...
<div class="modal dialog" id="envioModal" tabindex="-1" aria-labelledby="envioModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <a href="../scripts/logout.php" class="btn btn-secondary" tabindex="-1" role="button" aria-disabled="true">Cerrar sessión <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
  ...
  <tbody>
    <tr> 
      ...
      <th class="text-success fw-semibold">Completado</th>
      <th class="fw-lighter text-center">27/06/2024</th>
    </tr>
         ...
         <div class="row p-3"> 
          <div class="shadow p-3 mb-5 bg-body-tertiary rounded">
              ...
              <div class="col-sm-2">
                ...
                <input id="amount" class="mb-3 form-control" type="number" name="amount" min="0" step="0.01" value="0" required>
              </div>
              <div class="col-sm-3">
                ...
                <select id="from" class="form-select" aria-label="Default select example">
                  ...
                  <option selected value="MXN">MXN - Peso mexicano</option>
            <!-- Puedes añadir más opciones según tus necesidades -->
                  </select>
              </div>
              <div class="col-sm-3">
                <label class="form-label" for="to">A</label>
                <select id="to"  name="to" class="form-select" aria-label="Default select example">
                  <option value="USD">USD - Dolar Estadounidense</option>
                  <option value="EUR">EUR - Euro</option>
                  <option selected value="CAD">CAD - Dolar Canadiense</option>
                  <option  value="MXN">MXN - Peso mexicano</option>
            <!-- Puedes añadir más opciones según tus necesidades -->
                  </select>
              </div>
              <div class="col-sm-3 ">
                <label class="form-label" for="result">Conversión</label>
                <label  id="result" class="mb-3 form-control" type="number"  readonly></label>
