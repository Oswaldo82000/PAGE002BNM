...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">BNM</a>
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2"> 
              ...
              <?php  // Enlaces para cerrar sesión
              echo "<p><a  class='nav-link d-flex align-items-center gap-2' href='logout.php'><svg class='bi'><use xlink:href='#door-closed'/></svg>
                Sign out</a></p>"; 
                ?>
